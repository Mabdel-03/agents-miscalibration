...
SCHEDULER_SAFETY_PROTOCOL = (
    "schema5-v1.2-r14-serving-partition-scheduler-safety"
)
SCHEDULER_SAFETY_SCHEMA_VERSION = 1
CLIENT_CAPACITY_PROTOCOL = "schema5-v1.2-r14-mit-normal-client-capacity"
...
def capture_user_partition_usage(
    *,
    ...
    evidence: dict[str, Any] = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r14-user-partition-tres-usage",
        "captured_timestamp": timestamp,
        "user": user,
        "partition": partition,
        "argv": argv,
...
def validate_user_partition_usage(
    ...
    if (
        ...
        != "schema5-v1.2-r14-user-partition-tres-usage"
