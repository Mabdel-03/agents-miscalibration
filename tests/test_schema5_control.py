...
def attest_test_production_authorizations(
    ...
    manifest_path = root / "RECOVERY_CHAIN_SCHEMA5_V1_2_R9.json"
    chain_id = "1" * 64
    manifest = {
        "schema_version": 1,
        "release_id": control.PRODUCTION_RELEASE_ID,
    ...
    qualification_marker = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r9-throughput-qualification-v1",
        "passed": True,
        "release_id": control.PRODUCTION_RELEASE_ID,
        "release_tag": control.PRODUCTION_OPERATIONAL_TAG,
        "release_git_commit": current["immutable"]["git_commit"],
    ...
    drill_payload = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r9-external-watchdog-drill-v1",
        "drill_id": drill_id,
        "control_sha256": current["immutable_sha256"],
    }
    watchdog_payload = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r9-external-watchdog-v1",
...
def test_v12_release_and_environment_schema_downgrades_are_rejected(tmp_path):
    ...
    assert control.PRODUCTION_OPERATIONAL_TAG == "sweep-recovery-schema5-v1.2-r9"
