"""Reference invariants for the vendored metrics_reference module (handoff tests, imports fixed)."""
...
from agents_scaling.study import metrics_reference as metrics
