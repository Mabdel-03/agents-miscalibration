#!/usr/bin/env python3
"""Render, verify, and transactionally submit the schema-5 v1.2-r15 recovery DAG.
...
from scripts import (  # noqa: E402
    seal_schema5_r12_prelaunch_failure as r12_prelaunch_failure,
)
from scripts import (  # noqa: E402
    seal_schema5_r13_prelaunch_failure as r13_prelaunch_failure,
)
...
CHAIN_MANIFEST_NAME = "RECOVERY_CHAIN_SCHEMA5_V1_2_R15.json"
SUBMISSION_JOURNAL_NAME = ".RECOVERY_CHAIN_SCHEMA5_V1_2_R15.submission.json"
SUBMISSION_RECEIPT_NAME = "RECOVERY_CHAIN_SCHEMA5_V1_2_R15_SUBMISSION.json"
...
LAUNCH_COMPLETE_NAME = "RECOVERY_CHAIN_SCHEMA5_V1_2_R15_LAUNCHED.json"
BOOTSTRAP_WATCHDOG_READY_NAME = (
    "RECOVERY_CHAIN_BOOTSTRAP_WATCHDOG_READY.json"
)
BOOTSTRAP_WATCHDOG_READY_PROTOCOL = (
    "schema5-v1.2-r15-bootstrap-watchdog-deployment-ready-v1"
)
...
BOOTSTRAP_WATCHDOG_ARMED_PROTOCOL = (
    "schema5-v1.2-r15-bootstrap-watchdog-armed-v1"
)
...
BOOTSTRAP_WATCHDOG_HANDOFF_PROTOCOL = (
    "schema5-v1.2-r15-bootstrap-watchdog-handoff-v1"
)
...
BOOTSTRAP_ISOLATED_RENDER_LOCK_NAME = (
    ".RECOVERY_CHAIN_SCHEMA5_V1_2_R15.isolated-drill-render.lock"
)
...
REPAIR_ROOT_NAME = "recovery_chain_repairs_v1_2_r15"
CAPACITY_TRANSIENT_ROOT_NAME = "fleet_capacity_transients_v1_2_r15"
...
SUPERSEDED_R7_PRELAUNCH_FAILURE_RELATIVE_ROOT = (
    r7_prelaunch_failure.EVIDENCE_RELATIVE_ROOT
)
...
SUPERSEDED_R12_PRELAUNCH_FAILURE_RELATIVE_ROOT = (
    r12_prelaunch_failure.R12_FAILURE_RELATIVE
)
SUPERSEDED_R13_PRELAUNCH_FAILURE_RELATIVE_ROOT = (
    r13_prelaunch_failure.EVIDENCE_RELATIVE_ROOT
)
WATCHDOG_READY_MARKER_NAME = "WATCHDOG_READY.json"
WATCHDOG_READY_PROTOCOL = "schema5-v1.2-r15-external-watchdog-v1"
EXTERNAL_WATCHDOG_DRILL_MARKER_NAME = (
    "EXTERNAL_WATCHDOG_KILL_DRILL_COMPLETE.json"
)
EXTERNAL_WATCHDOG_DRILL_PROTOCOL = (
    "schema5-v1.2-r15-external-watchdog-drill-v1"
)
...
THROUGHPUT_QUALIFICATION_PROTOCOL = (
    "schema5-v1.2-r15-throughput-qualification-v3"
)
THROUGHPUT_QUALIFICATION_ACCOUNTING_SCHEMA_VERSION = 3
THROUGHPUT_QUALIFICATION_PLAN_PROTOCOL = (
    "schema5-v1.2-r15-throughput-qualification-load-plan-v3"
)
...
THROUGHPUT_QUALIFICATION_LEGACY_FAILURE_PROTOCOL = (
    "schema5-v1.2-r15-throughput-qualification-failure-v1"
)
...
RENDER_LOCK_NAME = ".RECOVERY_CHAIN_SCHEMA5_V1_2_R15.render.lock"
SUBMISSION_LOCK_NAME = ".RECOVERY_CHAIN_SCHEMA5_V1_2_R15.submit.lock"
...
SENTINEL_BOOTSTRAP_PROTOCOL = "schema5-v1.2-r15-sentinel-bootstrap"
SOURCE_CHECKOUT_SEAL_NAME = "SOURCE_CHECKOUT_SCHEMA5_V1_2_R15_COMPLETE.json"
SOURCE_CHECKOUT_SEAL_PROTOCOL = "schema5-v1.2-r15-source-checkout-seal-v1"
BUNDLED_TOOL_GIT_PATHS = (
    ...
    "scripts/seal_schema5_r10_prelaunch_failure.py",
    "scripts/seal_schema5_r11_prelaunch_failure.py",
    "scripts/seal_schema5_r12_prelaunch_failure.py",
    "scripts/seal_schema5_r13_prelaunch_failure.py",
)
...
PREREQUISITE_PROTOCOL = "schema5-v1.2-r15-prerequisite-evidence-v13"
...
R1_PROTOCOL_VERIFICATION_PROTOCOL = (
    "schema5-v1.2-r15-native-r1-evidence-verification-v1"
)
...
SMOKE_ATTEMPT_POINTER_PROTOCOL = (
    "schema5-v1.2-r15-smoke-attempt-pointer-v1"
)
SMOKE_CURRENT_SELECTOR_PROTOCOL = (
    "schema5-v1.2-r15-smoke-current-selector-v1"
)
SMOKE_ATTEMPT_COMPLETE_PROTOCOL = (
    "schema5-v1.2-r15-smoke-attempt-complete-v1"
)
SMOKE_ATTEMPT_FAILURE_PROTOCOL = (
    "schema5-v1.2-r15-smoke-attempt-failure-v1"
)
...
class RecoveryPaths:
    ...
    @property
    def superseded_r7_prelaunch_failure_root(self) -> Path:
        return (
            self.recovery_root
            / SUPERSEDED_R7_PRELAUNCH_FAILURE_RELATIVE_ROOT
        )
    ...
    @property
    def superseded_r8_prelaunch_failure_root(self) -> Path:
        return (
            self.recovery_root
            / SUPERSEDED_R8_PRELAUNCH_FAILURE_RELATIVE_ROOT
        )
    ...
    @property
    def superseded_r12_prelaunch_failure_root(self) -> Path:
        return (
            self.recovery_root
            / SUPERSEDED_R12_PRELAUNCH_FAILURE_RELATIVE_ROOT
        )
    ...
    @property
    def superseded_r13_prelaunch_failure_root(self) -> Path:
        return (
            self.recovery_root
            / SUPERSEDED_R13_PRELAUNCH_FAILURE_RELATIVE_ROOT
        )
...
def _job_comment(chain_id: str, name: str, generation: int) -> str:
    ...
    return f"asys:s5-recovery-v1.2-r15:{chain_id}:g{generation:04d}:{name}"
...
def recovery_paths(
    *,
    ...
    return RecoveryPaths(
        ...
        source_checkout=recovery_root / "release_source_checkout_v1_2_r15",
...
_BOOTSTRAP_PROBE_TOKEN = "schema5_v1_2_r15_sentinel_bootstrap_ok"
...
def _verified_superseded_r7_prelaunch_failure(
    paths: RecoveryPaths,
) -> dict[str, Any]:
    expected_root = (
        paths.recovery_root / SUPERSEDED_R7_PRELAUNCH_FAILURE_RELATIVE_ROOT
    )
    if paths.superseded_r7_prelaunch_failure_root != expected_root:
        raise ChainError("superseded r7 prelaunch-failure root is not canonical")
    try:
        binding = r7_prelaunch_failure.verify_failure_seal(
            expected_root,
            recovery_root=paths.recovery_root,
        )
    except (
        ...
        UnicodeError,
        ValueError,
        r7_prelaunch_failure.R7FailureSealError,
        r7_prelaunch_failure._helpers.R6FailureSealError,
        r7_prelaunch_failure._helpers.MarkerLastEvidenceError,
    ) as exc:
        raise ChainError(
            f"superseded r7 prelaunch-failure seal is invalid: {exc}"
        ) from exc
    expected_keys = {
        "passed",
        "root",
    ...
    if (
        ...
        or binding.get("passed") is not True
        or binding.get("root") != str(expected_root)
        or binding.get("protocol") != r7_prelaunch_failure.PROTOCOL
        or binding.get("release_tag") != r7_prelaunch_failure.R7_TAG
        or binding.get("release_git_commit") != r7_prelaunch_failure.R7_COMMIT
        or binding.get("chain_namespace") != r7_prelaunch_failure.R7_NAMESPACE
        or binding.get("marker")
        != str(expected_root / r7_prelaunch_failure.MARKER_NAME)
        or _SHA256.fullmatch(str(binding.get("marker_sha256", ""))) is None
        or _SHA256.fullmatch(str(binding.get("marker_id", ""))) is None
        or not isinstance(binding.get("marker_size"), int)
        or isinstance(binding.get("marker_size"), bool)
        or binding["marker_size"] <= 0
        or binding.get("classification") != r7_prelaunch_failure.CLASSIFICATION
        or binding.get("retry_in_place") is not False
        or binding.get("requires_superseding_release") is not True
        or binding.get("pre_scheduler_submission") is not True
        or binding.get("known_scheduler_job_ids") != []
    ):
        raise ChainError("superseded r7 prelaunch-failure binding drifted")
    return json.loads(json.dumps(binding, sort_keys=True))


def _verified_superseded_r8_prelaunch_failure(
    paths: RecoveryPaths,
) -> dict[str, Any]:
    expected_root = (
        paths.recovery_root / SUPERSEDED_R8_PRELAUNCH_FAILURE_RELATIVE_ROOT
    )
    if paths.superseded_r8_prelaunch_failure_root != expected_root:
        raise ChainError("superseded r8 prelaunch-failure root is not canonical")
    try:
        binding = r8_prelaunch_failure.verify_failure_seal(
            expected_root,
            recovery_root=paths.recovery_root,
        )
    except (
        ...
        UnicodeError,
        ValueError,
        r8_prelaunch_failure.R8FailureSealError,
        *r8_prelaunch_failure.MarkerLastEvidenceError,
    ) as exc:
        raise ChainError(
            f"superseded r8 prelaunch-failure seal is invalid: {exc}"
        ) from exc
    expected_keys = {
        "passed",
        "root",
    ...
    if (
        ...
        or binding.get("passed") is not True
        or binding.get("root") != str(expected_root)
        or binding.get("protocol") != r8_prelaunch_failure.PROTOCOL
        or binding.get("release_tag") != r8_prelaunch_failure.R8_TAG
        or binding.get("release_git_commit") != r8_prelaunch_failure.R8_COMMIT
        or binding.get("chain_namespace") != r8_prelaunch_failure.R8_NAMESPACE
        or binding.get("marker")
        != str(expected_root / r8_prelaunch_failure.MARKER_NAME)
        or _SHA256.fullmatch(str(binding.get("marker_sha256", ""))) is None
        or _SHA256.fullmatch(str(binding.get("marker_id", ""))) is None
        or not isinstance(binding.get("marker_size"), int)
        or isinstance(binding.get("marker_size"), bool)
        or binding["marker_size"] <= 0
        or binding.get("classification") != r8_prelaunch_failure.CLASSIFICATION
        or binding.get("retry_in_place") is not False
        or binding.get("requires_superseding_release") is not True
        or binding.get("pre_scheduler_submission") is not True
        or binding.get("known_scheduler_job_ids") != []
    ):
        raise ChainError("superseded r8 prelaunch-failure binding drifted")
    return json.loads(json.dumps(binding, sort_keys=True))
...
def _verified_superseded_r12_prelaunch_failure(
    paths: RecoveryPaths,
) -> dict[str, Any]:
    expected_root = (
        paths.recovery_root
    ...
    if paths.superseded_r12_prelaunch_failure_root != expected_root:
        raise ChainError("superseded r12 prelaunch-failure root is not canonical")
    try:
        binding = r12_prelaunch_failure.verify_failure_seal(
            expected_root,
            recovery_root=paths.recovery_root,
        )
    except (
        ...
        UnicodeError,
        ValueError,
        *r12_prelaunch_failure.MarkerLastEvidenceError,
    ) as exc:
        raise ChainError(
            f"superseded r12 prelaunch-failure seal is invalid: {exc}"
        ) from exc
    expected_keys = {
        "passed",
        "root",
    ...
    if (
        ...
        or binding.get("passed") is not True
        or binding.get("root") != str(expected_root)
        or binding.get("protocol") != r12_prelaunch_failure.PROTOCOL
        or binding.get("release_tag") != r12_prelaunch_failure.R12_TAG
        or binding.get("release_git_commit")
        != r12_prelaunch_failure.R12_COMMIT
        or binding.get("chain_namespace")
        != r12_prelaunch_failure.R12_NAMESPACE
        or binding.get("marker")
        != str(expected_root / r12_prelaunch_failure.MARKER_NAME)
        or _SHA256.fullmatch(str(binding.get("marker_sha256", ""))) is None
        or _SHA256.fullmatch(str(binding.get("marker_id", ""))) is None
        or not isinstance(binding.get("marker_size"), int)
        or isinstance(binding.get("marker_size"), bool)
        or binding["marker_size"] <= 0
        or binding.get("classification")
        != r12_prelaunch_failure.CLASSIFICATION
        or binding.get("retry_in_place") is not False
        or binding.get("requires_superseding_release") is not True
        or binding.get("pre_scheduler_submission") is not True
        or binding.get("known_scheduler_job_ids") != []
    ):
        raise ChainError("superseded r12 prelaunch-failure binding drifted")
    return json.loads(json.dumps(binding, sort_keys=True))


def _verified_superseded_r13_prelaunch_failure(
    paths: RecoveryPaths,
) -> dict[str, Any]:
    expected_root = (
        paths.recovery_root
    ...
    if paths.superseded_r13_prelaunch_failure_root != expected_root:
        raise ChainError("superseded r13 prelaunch-failure root is not canonical")
    try:
        binding = r13_prelaunch_failure.verify_failure_seal(
            expected_root,
            recovery_root=paths.recovery_root,
        )
    except (
        ...
        UnicodeError,
        ValueError,
        *r13_prelaunch_failure.MarkerLastEvidenceError,
    ) as exc:
        raise ChainError(
            f"superseded r13 prelaunch-failure seal is invalid: {exc}"
        ) from exc
    expected_keys = {
        "passed",
        "root",
    ...
    if (
        ...
        or binding.get("passed") is not True
        or binding.get("root") != str(expected_root)
        or binding.get("protocol") != r13_prelaunch_failure.PROTOCOL
        or binding.get("release_tag") != r13_prelaunch_failure.R13_TAG
        or binding.get("release_git_commit")
        != r13_prelaunch_failure.R13_COMMIT
        or binding.get("chain_namespace")
        != r13_prelaunch_failure.R13_NAMESPACE
        or binding.get("marker")
        != str(expected_root / r13_prelaunch_failure.MARKER_NAME)
        or _SHA256.fullmatch(str(binding.get("marker_sha256", ""))) is None
        or _SHA256.fullmatch(str(binding.get("marker_id", ""))) is None
        or not isinstance(binding.get("marker_size"), int)
        or isinstance(binding.get("marker_size"), bool)
        or binding["marker_size"] <= 0
        or binding.get("classification")
        != r13_prelaunch_failure.CLASSIFICATION
        or binding.get("retry_in_place") is not False
        or binding.get("requires_superseding_release") is not True
        or binding.get("pre_scheduler_submission") is not True
        or binding.get("known_scheduler_job_ids") != []
    ):
        raise ChainError("superseded r13 prelaunch-failure binding drifted")
    return json.loads(json.dumps(binding, sort_keys=True))
...
def _external_launch_prerequisite_contract(
    ...
    superseded_r12 = _verified_superseded_r12_prelaunch_failure(paths)
    superseded_r13 = _verified_superseded_r13_prelaunch_failure(paths)
    return {
        "durable_git_release": {
        ...
        "superseded_r12_prelaunch_failure": superseded_r12,
        "superseded_r13_prelaunch_failure": superseded_r13,
...
def _validate_prerequisite_evidence_contract(
    ...
    *,
    ...
    required = {
        ...
        "superseded_r12_prelaunch_failure",
        "superseded_r13_prelaunch_failure",
        "protected_capacity",
        "materialization_pilot",
        "slurm_canary",
        "evidence_id",
...
if [[ ! "$launch_gate_comment" =~ ^asys:s5-recovery-v1\.2-r15:([0-9a-f]{64}):g([0-9]{4}):([A-Za-z0-9._-]+)$ ]]; then
...
expected_comment = (
    f"asys:s5-recovery-v1.2-r15:{chain_id}:g{generation:04d}:{stage_name}"
)
...
if (
    ...
    or manifest.get("protocol") != "schema5-v1.2-r15-recovery-chain"
...
r7_binding = canary_source.get("superseded_r7_prelaunch_failure")
r7_root = (
    Path(str(manifest.get("recovery_root", "")))
    / "prelaunch_failures"
    / "schema5-v1.2-r7-git-index-refresh"
)
_, r7_sealer_path = bundled_record(
    "scripts/seal_schema5_r7_prelaunch_failure.py"
)
try:
    observed_r7_binding = runpy.run_path(str(r7_sealer_path))[
        "verify_failure_seal"
    ](
        r7_root,
        recovery_root=Path(str(manifest.get("recovery_root", ""))),
    ...
    fail(f"superseded r7 prelaunch-failure verification failed: {error}")
if observed_r7_binding != r7_binding:
    fail("superseded r7 prelaunch-failure seal differs from manifest")

r8_binding = canary_source.get("superseded_r8_prelaunch_failure")
r8_root = (
    Path(str(manifest.get("recovery_root", "")))
    / "prelaunch_failures"
    / "schema5-v1.2-r8-r3-probe-import"
)
_, r8_sealer_path = bundled_record(
    "scripts/seal_schema5_r8_prelaunch_failure.py"
)
try:
    observed_r8_binding = runpy.run_path(str(r8_sealer_path))[
        "verify_failure_seal"
    ](
        r8_root,
        recovery_root=Path(str(manifest.get("recovery_root", ""))),
...
r12_binding = canary_source.get("superseded_r12_prelaunch_failure")
r12_root = (
    Path(str(manifest.get("recovery_root", "")))
    / "prelaunch_failures"
    / "schema5-v1.2-r12-r9-verifier"
)
_, r12_sealer_path = bundled_record(
    "scripts/seal_schema5_r12_prelaunch_failure.py"
)
try:
    observed_r12_binding = runpy.run_path(str(r12_sealer_path))[
        "verify_failure_seal"
    ](
        r12_root,
        recovery_root=Path(str(manifest.get("recovery_root", ""))),
    ...
    fail(f"superseded r12 prelaunch-failure verification failed: {error}")
if observed_r12_binding != r12_binding:
    fail("superseded r12 prelaunch-failure seal differs from manifest")

r13_binding = canary_source.get("superseded_r13_prelaunch_failure")
r13_root = (
    Path(str(manifest.get("recovery_root", "")))
    / "prelaunch_failures"
    / "schema5-v1.2-r13-r3-offline-delimiter"
)
_, r13_sealer_path = bundled_record(
    "scripts/seal_schema5_r13_prelaunch_failure.py"
)
try:
    observed_r13_binding = runpy.run_path(str(r13_sealer_path))[
        "verify_failure_seal"
    ](
        r13_root,
        recovery_root=Path(str(manifest.get("recovery_root", ""))),
    ...
    fail(f"superseded r13 prelaunch-failure verification failed: {error}")
if observed_r13_binding != r13_binding:
    fail("superseded r13 prelaunch-failure seal differs from manifest")
...
expected_receipt_protocol = (
    "schema5-v1.2-r15-recovery-chain-submission"
    if generation == 0
    else "schema5-v1.2-r15-recovery-chain-repair"
)
if (
...
if (
    policy.get("protocol") != "schema5-v1.2-r15-live-dependency-policy-v1"
...
for manifest_row, record in zip(manifest_jobs, receipt_jobs, strict=True):
    ...
    expected_record_comment = (
        f"asys:s5-recovery-v1.2-r15:{chain_id}:"
...
if (
    ...
    != "schema5-v1.2-r15-recovery-root-release-v1"
...
if generation == 0:
    ...
    if (
        ...
        != "schema5-v1.2-r15-bootstrap-generation-provenance-v1"
...
if (
    ...
    != "schema5-v1.2-r15-live-dependency-policy-v1"
...
for ordinal, attempt_binding in enumerate(
    ...
    if (
        ...
        != "schema5-v1.2-r15-root-release-attempt-intent-v1"
        ...
        != "schema5-v1.2-r15-root-release-attempt-result-v1"
...
if (
    ...
    != "schema5-v1.2-r15-recovery-chain-launched-v1"
...
if [[ "$comment" =~ ^asys:s5-recovery-v1\\.2-r15:([0-9a-f]{{64}}):g[0-9]{{4}}:source_checkout$ ]]; then
  scheduler_chain_id="${{BASH_REMATCH[1]}}"
else
  echo "source checkout scheduler identity is outside the immutable r15 chain" >&2
  exit 2
fi
...
email_comment_re="^asys:s5-recovery-v1\\\\.2-r15:${{chain_id}}:g([0-9]{{4}}):email_readiness$"
...
if [[ "$comment" =~ ^asys:s5-recovery-v1\\.2-r15:[0-9a-f]{{64}}:(g[0-9]{{4}}):fleet_readiness$ ]]; then
  generation="${{BASH_REMATCH[1]}}"
else
  echo "fleet readiness scheduler comment is outside the immutable r15 namespace: $comment" >&2
  exit 2
fi
...
def _r7_prelaunch_failure_shell_check(
    paths: RecoveryPaths,
    *,
    verifier_payload: bytes,
) -> str:
    verifier = paths.jobs_root / "seal_schema5_r7_prelaunch_failure.py"
    if not verifier_payload:
        raise ChainError("bundled r7 prelaunch-failure verifier is missing")
    return f"""\
r7_failure_verifier={_q(verifier)}
{_immutable_tool_shell_check(
    variable="r7_failure_verifier",
    expected_sha256=_sha256_bytes(verifier_payload),
    expected_size=len(verifier_payload),
    description="bundled r7 prelaunch-failure verifier",
)}
env LD_LIBRARY_PATH="$bootstrap_root/lib" "$bootstrap_python" -I -S \
  "$r7_failure_verifier" verify \
  --evidence-root {_q(paths.superseded_r7_prelaunch_failure_root)} \
  --recovery-root {_q(paths.recovery_root)}
"""


def _r8_prelaunch_failure_shell_check(
    paths: RecoveryPaths,
    *,
    verifier_payload: bytes,
) -> str:
    verifier = paths.jobs_root / "seal_schema5_r8_prelaunch_failure.py"
    if not verifier_payload:
        raise ChainError("bundled r8 prelaunch-failure verifier is missing")
    return f"""\
r8_failure_verifier={_q(verifier)}
{_immutable_tool_shell_check(
    variable="r8_failure_verifier",
    expected_sha256=_sha256_bytes(verifier_payload),
    expected_size=len(verifier_payload),
    description="bundled r8 prelaunch-failure verifier",
)}
env LD_LIBRARY_PATH="$bootstrap_root/lib" "$bootstrap_python" -I -S \
  "$r8_failure_verifier" verify \
  --evidence-root {_q(paths.superseded_r8_prelaunch_failure_root)} \
  --recovery-root {_q(paths.recovery_root)}
"""
...
def _r12_prelaunch_failure_shell_check(
    paths: RecoveryPaths,
    *,
    verifier_payload: bytes,
) -> str:
    verifier = paths.jobs_root / "seal_schema5_r12_prelaunch_failure.py"
    if not verifier_payload:
        raise ChainError("bundled r12 prelaunch-failure verifier is missing")
    return f"""\
r12_failure_verifier={_q(verifier)}
{_immutable_tool_shell_check(
    variable="r12_failure_verifier",
    expected_sha256=_sha256_bytes(verifier_payload),
    expected_size=len(verifier_payload),
    description="bundled r12 prelaunch-failure verifier",
)}
env LD_LIBRARY_PATH="$bootstrap_root/lib" "$bootstrap_python" -I -S \
  "$r12_failure_verifier" verify \
  --evidence-root {_q(paths.superseded_r12_prelaunch_failure_root)} \
  --recovery-root {_q(paths.recovery_root)}
"""


def _r13_prelaunch_failure_shell_check(
    paths: RecoveryPaths,
    *,
    verifier_payload: bytes,
) -> str:
    verifier = paths.jobs_root / "seal_schema5_r13_prelaunch_failure.py"
    if not verifier_payload:
        raise ChainError("bundled r13 prelaunch-failure verifier is missing")
    return f"""\
r13_failure_verifier={_q(verifier)}
{_immutable_tool_shell_check(
    variable="r13_failure_verifier",
    expected_sha256=_sha256_bytes(verifier_payload),
    expected_size=len(verifier_payload),
    description="bundled r13 prelaunch-failure verifier",
)}
env LD_LIBRARY_PATH="$bootstrap_root/lib" "$bootstrap_python" -I -S \
  "$r13_failure_verifier" verify \
  --evidence-root {_q(paths.superseded_r13_prelaunch_failure_root)} \
  --recovery-root {_q(paths.recovery_root)}
"""
...
def _failure_sentinel_body(
    ...
    *,
    ...
    r12_failure_verifier_payload: bytes,
    r13_failure_verifier_payload: bytes,
) -> str:
...
{_r7_prelaunch_failure_shell_check(
    paths, verifier_payload=r7_failure_verifier_payload
)}
...
{_r12_prelaunch_failure_shell_check(
    paths, verifier_payload=r12_failure_verifier_payload
)}
{_r13_prelaunch_failure_shell_check(
    paths, verifier_payload=r13_failure_verifier_payload
)}
job_record="$(scontrol show job -o "$SLURM_JOB_ID")"
comment="$(tr ' ' '\\n' <<<"$job_record" | sed -n 's/^Comment=//p')"
[[ "$(wc -l <<<"$comment")" -eq 1 ]] || {{ echo "sentinel scheduler comment is ambiguous" >&2; exit 2; }}
if [[ "$comment" =~ ^asys:s5-recovery-v1\\.2-r15:[0-9a-f]{{64}}:(g[0-9]{{4}}):failure_sentinel$ ]]; then
  generation="${{BASH_REMATCH[1]}}"
else
  echo "sentinel scheduler comment is outside the immutable r15 namespace: $comment" >&2
  exit 2
fi
if [[ "$generation" == g0000 ]]; then
  receipt={_q(paths.recovery_root / SUBMISSION_RECEIPT_NAME)}
...
if [[ "$comment" =~ ^asys:s5-recovery-v1\\.2-r15:[0-9a-f]{{64}}:(g[0-9]{{4}}):{re.escape(observer_name)}$ ]]; then
  generation="${{BASH_REMATCH[1]}}"
else
  echo "stage sentinel scheduler comment is outside the immutable r15 namespace: $comment" >&2
  exit 2
fi
if [[ "$generation" == g0000 ]]; then
  receipt={_q(paths.recovery_root / SUBMISSION_RECEIPT_NAME)}
        ...
        *(
            JobSpec(
                ...
                _stage_failure_sentinel_body(
                    ...
                    r7_failure_verifier_payload=bundled_tools[
                    ...
                    r12_failure_verifier_payload=bundled_tools[
                        "seal_schema5_r12_prelaunch_failure.py"
                    ],
                    r13_failure_verifier_payload=bundled_tools[
                        "seal_schema5_r13_prelaunch_failure.py"
                    ],
                ),
...
def _job_name(name: str) -> str:
    if name.startswith(STAGE_SENTINEL_PREFIX):
        ...
        return f"asys-s5v12r15-alert-{PRODUCTION_STAGE_NAMES.index(stage):02d}"
    shortened = {
    ...
    return f"asys-s5v12r15-{shortened}"
...
def _validate_dag(specs: Sequence[JobSpec]) -> None:
    ...
    if observed_contract != EXPECTED_JOB_CONTRACT:
        raise ChainError("recovery DAG differs from the fixed v1.2-r15 job contract")
...
def _preflight_fresh_destinations(paths: RecoveryPaths) -> None:
    for description, path in (
        ("v1.2-r15 source checkout", paths.source_checkout),
        (
            "v1.2-r15 source checkout seal",
    ...
    payload.update(
        {
            ...
            "source_checkout": str(
                isolated_root / "release_source_checkout_v1_2_r15"
            ),
            "release_root": str(
...
def render_chain(
    ...
    *,
    ...
    if not apply:
        ...
        for description, path in (
            ("v1.2-r15 job namespace", paths.jobs_root),
            ("v1.2-r15 log namespace", paths.logs_root),
            ("v1.2-r15 chain manifest", paths.chain_manifest),
        ):
            if path.exists() or path.is_symlink():
                raise ChainError(f"{description} must be fresh and absent: {path}")
        return report
...
def verify_chain(manifest_path: Path) -> dict[str, Any]:
    ...
    if (
        ...
        or manifest["protocol"] != "schema5-v1.2-r15-recovery-chain"
...
def _verify_r15_throughput_evidence(
    *,
    attempt_root: Path,
    marker: Mapping[str, Any],
) -> dict[str, Any]:
...
def verify_throughput_qualification(
    ...
    evidence_report = _verify_r15_throughput_evidence(
        attempt_root=attempt_root,
        marker=marker,
    )
...
def _bootstrap_receipt_lineage(
    *,
    ...
    if protocol == "schema5-v1.2-r15-recovery-chain-submission":
        current_generation = 0
    elif protocol == "schema5-v1.2-r15-recovery-chain-repair":
...
def _validate_bootstrap_scheduler_namespace(
    *,
    ...
    prefix = (
        f"asys:s5-recovery-v1.2-r15:{manifest['chain_id']}:g"
    )
...
def _dependency_config_allows_fail_closed(
    ...
    return {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r15-live-dependency-policy-v1",
...
def _validate_submission_journal(
    ...
    *,
    ...
    if (
        ...
        or journal["protocol"] != "schema5-v1.2-r15-recovery-chain-submission"
...
def _validate_submission_receipt(
    ...
    *,
    ...
    if (
        ...
        or receipt["protocol"] != "schema5-v1.2-r15-recovery-chain-submission"
...
def _validate_scheduler_acceptance(
    ...
    *,
    ...
    if (
        ...
        != "schema5-v1.2-r15-recovery-scheduler-acceptance-intent-v1"
...
def _validate_bootstrap_watchdog_deployment_ready(
    ...
    *,
    ...
    if (
        ...
        != "schema5-v1.2-r15-bootstrap-watchdog-bundle-v1"
        ...
        != "schema5-v1.2-r15-bootstrap-watchdog-deployment-evidence-v1"
        ...
        != "schema5-v1.2-r15-bootstrap-watchdog-drill-evidence-v1"
...
def _validate_bootstrap_watchdog_armed(
    ...
    *,
    ...
    if valid_observation_artifacts:
        for binding, summary in zip(
            ...
            if (
                ...
                != "schema5-v1.2-r15-bootstrap-status-v1"
    ...
    if (
        ...
        or intent.get("schema_version") != 1
        or intent.get("protocol")
        != "schema5-v1.2-r15-bootstrap-watchdog-arm-intent-v1"
        or intent.get("chain_id") != manifest.get("chain_id")
        or intent.get("submission_receipt") != str(receipt_path)
        or intent.get("submission_receipt_sha256") != _sha256(receipt_path)
        or intent.get("submission_receipt_id") != receipt.get("receipt_id")
...
def _ensure_bootstrap_descendant_armed(
    *,
    ...
    intent: dict[str, Any] = {
        "schema_version": 1,
        "protocol": (
            "schema5-v1.2-r15-bootstrap-descendant-arm-intent-v1"
        ),
        "chain_id": manifest["chain_id"],
...
def _validate_launch_complete(
    ...
    *,
    ...
    if receipt.get("protocol") == "schema5-v1.2-r15-recovery-chain-submission":
        required |= {
            "bootstrap_watchdog_ready",
            "bootstrap_watchdog_ready_sha256",
            "bootstrap_watchdog_ready_id",
    ...
    *,
    ...
    def publish_launch(release: Mapping[str, Any]) -> dict[str, Any]:
        launch = {
            ...
            "protocol": "schema5-v1.2-r15-recovery-chain-launched-v1",
    ...
    release_intent = {
        "schema_version": SUBMISSION_SCHEMA_VERSION,
        "protocol": "schema5-v1.2-r15-recovery-root-release-intent-v1",
        "created_at": _utc_now(),
        "receipt": str(receipt_path),
        "receipt_sha256": _sha256(receipt_path),
        "receipt_id": receipt["receipt_id"],
    ...
    release = {
        "schema_version": SUBMISSION_SCHEMA_VERSION,
        "protocol": "schema5-v1.2-r15-recovery-root-release-v1",
        "completed_at": _utc_now(),
        "receipt": str(receipt_path),
        "receipt_sha256": _sha256(receipt_path),
        "receipt_id": receipt["receipt_id"],
    ...
    *,
    ...
    with _exclusive_lock(lock_path, description="recovery-chain submitter"):
        ...
        if journal_path.exists() or journal_path.is_symlink():
            ...
            journal = {
                "schema_version": SUBMISSION_SCHEMA_VERSION,
                "protocol": "schema5-v1.2-r15-recovery-chain-submission",
                "chain_id": manifest["chain_id"],
                "manifest": str(manifest_path),
                "started_at": _utc_now(),
...
def _validate_repair_receipt(
    ...
    *,
    ...
    if (
        ...
        or receipt.get("protocol") != "schema5-v1.2-r15-recovery-chain-repair"
        or receipt.get("passed") is not True
...
def _validate_repair_journal(
    ...
    *,
    ...
    if (
        ...
        or journal.get("protocol") != "schema5-v1.2-r15-recovery-chain-repair-journal"
...
def _validate_capacity_transient_repair_binding(
    *,
    ...
    if (
        ...
        or marker.get("protocol")
        != "schema5-v1.2-r15-fleet-capacity-transient-receipt"
        or marker.get("passed") is not True
        ...
        != "schema5-v1.2-r15-fleet-capacity-transient-evidence"
...
def _sentinel_repair_jobs(
    *,
    ...
    if (
        marker.get("schema_version") != 1
        or marker.get("protocol")
        != "schema5-v1.2-r15-recovery-sentinel-outcome"
        or marker.get("passed") is not True
        or marker.get("chain_id") != manifest["chain_id"]
        or marker.get("manifest") != str(manifest_path)
        or marker.get("manifest_sha256") != _sha256(manifest_path)
        ...
        or evidence.get("protocol")
        != "schema5-v1.2-r15-recovery-scheduler-evidence"
        or evidence.get("passed") is not True
...
def _ensure_bootstrap_generation_provenance(
    *,
    ...
    payload: dict[str, Any] = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r15-bootstrap-generation-provenance-v1",
        "passed": True,
        "release_git_commit": manifest["release_git_commit"],
        "release_tag_object": manifest["release_tag_object"],
        "chain_id": manifest["chain_id"],
...
def bootstrap_status(
    ...
    *,
    ...
    observation: dict[str, Any] = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r15-bootstrap-status-v1",
        "passed": True,
    ...
    *,
    ...
    with _exclusive_lock(lock_path, description="recovery-chain repair"):
        ...
        if pending is None:
            ...
            journal = {
                "schema_version": SUBMISSION_SCHEMA_VERSION,
                "protocol": "schema5-v1.2-r15-recovery-chain-repair-journal",
        ...
        receipt = {
            "schema_version": SUBMISSION_SCHEMA_VERSION,
            "protocol": "schema5-v1.2-r15-recovery-chain-repair", "passed": True,
...
def quarantine_partial_materialization(
    ...
    *,
    ...
    with _exclusive_lock(lock_path, description="materialization quarantine"):
        ...
        expected_intent = {
            "schema_version": 1,
            "protocol": "schema5-v1.2-r15-partial-materialization-quarantine-intent",
            "chain_id": manifest["chain_id"],
            "manifest": str(manifest_path),
            "manifest_sha256": _sha256(manifest_path),
            "receipt": str(receipt_path),
        ...
        if completion_path.exists() or completion_path.is_symlink():
            ...
            expected_completion = {
                "schema_version": 1,
                "protocol": "schema5-v1.2-r15-partial-materialization-quarantine",
                "passed": True,
                "release_id": RELEASE_ID,
                "materialize_job_id": materialize_job_id,
                "materialize_job_state": materialize_state["state"],
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    render = subparsers.add_parser("render", help="dry-run or publish the v1.2-r15 chain")
    ...
    isolated_drill.add_argument(
        ...
        required=True,
        type=Path,
        help="canonical submitted r15 recovery-chain manifest",
    )
