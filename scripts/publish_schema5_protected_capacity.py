...
Both objects must carry the exact schema-5 v1.2-r15 release and chain namespace.
...
PROTOCOL = "schema5-v1.2-r15-protected-capacity-v4"
SCHEDULER_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r15-protected-capacity-scheduler-evidence-v4"
)
CANARY_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r15-protected-capacity-canary-evidence-v4"
)
CAPACITY_SOURCE = (
...
def _validate_occupancy_preflight(
    ...
    *,
    ...
    if (
        value.get("protocol")
        != "schema5-v1.2-r15-protected-capacity-occupancy-preflight-v3"
...
def validate_marker_payload(
    ...
    *,
    ...
    """Validate the exact marker schema used by the r15 chain renderer."""
