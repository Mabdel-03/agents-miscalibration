...
Both objects must carry the exact schema-5 v1.2-r13 release and chain namespace.
...
PROTOCOL = "schema5-v1.2-r13-protected-capacity-v4"
SCHEDULER_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r13-protected-capacity-scheduler-evidence-v4"
)
CANARY_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r13-protected-capacity-canary-evidence-v4"
)
CAPACITY_SOURCE = (
...
def validate_marker_payload(
    ...
    *,
    ...
    """Validate the exact marker schema used by the r13 chain renderer."""
