...
Both objects must carry the exact schema-5 v1.2-r5 release and chain namespace.
...
SCHEDULER_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r5-protected-capacity-scheduler-evidence-v4"
)
CANARY_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r5-protected-capacity-canary-evidence-v4"
)
CAPACITY_SOURCE = (
...
def validate_marker_payload(
    ...
    *,
    ...
    """Validate the exact marker schema used by the r5 chain renderer."""
