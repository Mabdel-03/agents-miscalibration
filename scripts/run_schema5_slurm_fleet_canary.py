...
TURNOVER_PORT_DERIVATION_PROTOCOL = (
    "schema5-v1.2-r15-turnover-run-token-port-derivation-v1"
)
...
PROFILE = "canary-cpu"
REQUIRED_RELEASE_TAG = "sweep-recovery-schema5-v1.2-r15"
...
CODE_IDENTITY_PROTOCOL = "schema5-v1.2-r15-slurm-canary-code-v3"
