...
SBATCH_JOB_NAME = "asys-s5-materialization-pilot-r6"
_SBATCH_TOKEN_RE = re.compile(r"[A-Za-z0-9_.%/+=:-]+\Z")
PILOT_QUARANTINE_PROTOCOL = "schema5-v1.2-r6-materialization-pilot-quarantine"
PILOT_QUARANTINE_INTENT_PROTOCOL = (
    "schema5-v1.2-r6-materialization-pilot-quarantine-intent"
)
...
SCHEDULER_INTENT_PROTOCOL = "schema5-v1.2-r6-pilot-scheduler-intent"
SCHEDULER_ACTIVE_PROTOCOL = "schema5-v1.2-r6-pilot-scheduler-active"
SCHEDULER_ACCEPTANCE_PROTOCOL = "schema5-v1.2-r6-pilot-scheduler-acceptance"
...
SUBMISSION_INTENT_PROTOCOL = "schema5-v1.2-r6-pilot-submission-intent"
SUBMISSION_ATTEMPT_PROTOCOL = "schema5-v1.2-r6-pilot-submission-attempt"
SUBMISSION_RESULT_PROTOCOL = "schema5-v1.2-r6-pilot-submission-result"
SUBMISSION_ABSENT_PROTOCOL = "schema5-v1.2-r6-pilot-submission-absent"
SUBMISSION_ACCEPTED_PROTOCOL = "schema5-v1.2-r6-pilot-submission-accepted"
