...
# Two r14 attempts proved 11:30 is not a survivable budget for this data volume.
# Attempt 1 reached CAPTURE_VERIFY at T+8h02m and was still materializing at T+10h07m;
# attempt 2 was pacing slower still.  The cost is inherent rather than incidental: the
# contract's repeated inventory and checksum passes drove 236 GB of reads to write
# 14.6 GB, and the 8.3 GB serving seed alone took 2h38m over Lustre.  The submitter
# validates the live job's TimeLimit against this constant from both scontrol and
# squeue, so an `sbatch --time=` override is rejected by design -- raising it here is
# the only correct fix.  23:00 fits every partition that offers a 1-day ceiling.
SBATCH_TIME_LIMIT = "23:00:00"
SBATCH_JOB_NAME = "asys-s5-materialization-pilot-r15"
_SBATCH_TOKEN_RE = re.compile(r"[A-Za-z0-9_.%/+=:-]+\Z")
PILOT_QUARANTINE_PROTOCOL = "schema5-v1.2-r15-materialization-pilot-quarantine"
PILOT_QUARANTINE_INTENT_PROTOCOL = (
    "schema5-v1.2-r15-materialization-pilot-quarantine-intent"
)
...
SCHEDULER_INTENT_PROTOCOL = "schema5-v1.2-r15-pilot-scheduler-intent"
SCHEDULER_ACTIVE_PROTOCOL = "schema5-v1.2-r15-pilot-scheduler-active"
SCHEDULER_ACCEPTANCE_PROTOCOL = "schema5-v1.2-r15-pilot-scheduler-acceptance"
...
SUBMISSION_INTENT_PROTOCOL = "schema5-v1.2-r15-pilot-submission-intent"
SUBMISSION_ATTEMPT_PROTOCOL = "schema5-v1.2-r15-pilot-submission-attempt"
SUBMISSION_RESULT_PROTOCOL = "schema5-v1.2-r15-pilot-submission-result"
SUBMISSION_ABSENT_PROTOCOL = "schema5-v1.2-r15-pilot-submission-absent"
SUBMISSION_ACCEPTED_PROTOCOL = "schema5-v1.2-r15-pilot-submission-accepted"
