...
ATTEMPT_POINTER_PROTOCOL = "schema5-v1.2-r9-smoke-attempt-pointer-v1"
CURRENT_SELECTOR_PROTOCOL = "schema5-v1.2-r9-smoke-current-selector-v1"
ATTEMPT_COMPLETE_PROTOCOL = "schema5-v1.2-r9-smoke-attempt-complete-v1"
ATTEMPT_FAILURE_PROTOCOL = "schema5-v1.2-r9-smoke-attempt-failure-v1"
