...
BOOTSTRAP_ATTESTATION_PROTOCOL = (
    "schema5-v1.2-r10-bootstrap-watchdog-attestation-v1"
)
...
BOOTSTRAP_CHAIN_MANIFEST_NAME = "RECOVERY_CHAIN_SCHEMA5_V1_2_R10.json"
BOOTSTRAP_SUBMISSION_RECEIPT_NAME = (
    "RECOVERY_CHAIN_SCHEMA5_V1_2_R10_SUBMISSION.json"
)
BOOTSTRAP_CANONICAL_REPAIR_DIRECTORY = "recovery_chain_repairs_v1_2_r10"
BOOTSTRAP_CANONICAL_ROOT_RELEASE_MARKER = (
    "RECOVERY_CHAIN_ROOT_RELEASE_COMPLETE.json"
)
BOOTSTRAP_CANONICAL_LAUNCH_MARKER = (
    "RECOVERY_CHAIN_SCHEMA5_V1_2_R10_LAUNCHED.json"
)
ACK_PROTOCOL = "schema5-external-watchdog-liveness-ack-v1"
HEARTBEAT_PROTOCOL = "schema5-v1.2-r10-external-watchdog-v1"
...
def _bootstrap_pilot_release_binding(
    *,
    ...
    """Authenticate the exact r10 pilot layout and sealed source bundle."""
...
def _bootstrap_chain_anchor(
    *,
    ...
    if (
        manifest.get("protocol") != "schema5-v1.2-r10-recovery-chain"
...
def _bootstrap_isolated_drill_contract(
    *,
    ...
    contract: dict[str, Any] = {
        "schema_version": 1,
        "protocol": (
            "schema5-v1.2-r10-bootstrap-isolated-cancellation-drill-v1"
        ),
...
def build_bootstrap_bundle(
    *,
    ...
    config = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r10-bootstrap-watchdog-config-v1",
        "release_git_commit": git_commit,
        "release_tag_object": tag_object,
...
def capture_bootstrap_deployment_evidence(
    *,
    ...
    if (
        ...
        != "schema5-v1.2-r10-bootstrap-watchdog-config-v1"
    ...
    if (
        ...
        != "schema5-v1.2-r10-bootstrap-watchdog-heartbeat-v1"
...
def _validate_bootstrap_observation(
    *,
    ...
    if (
        value.get("protocol") != "schema5-v1.2-r10-bootstrap-status-v1"
        or value.get("passed") is not True
        or value.get("observation_id")
        != _self_hash(value, "observation_id")
