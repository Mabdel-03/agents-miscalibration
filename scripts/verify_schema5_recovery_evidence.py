...
their native protocol semantics; neither is reinterpreted as the active v1.2-r12
...
R12_PROTOCOL = "schema5-v1.2-r12-recovery-chain"
_RENDERERS = {
    R1_PROTOCOL: "render_schema5_recovery_chain",
    R12_PROTOCOL: "render_schema5_recovery_chain_v12",
}
...
def _historical_r2_chain(
    ...
    """Validate immutable r2 bytes without importing the active r12 renderer."""
