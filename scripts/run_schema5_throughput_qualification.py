...
# Qualification artifacts are created by the active r12 chain.  Their schema version
# remains v1 where appropriate, but their protocol identity must never claim r2.
SCHEMA_VERSION = 1
RECOVERY_CHAIN_PROTOCOL = "schema5-v1.2-r12-recovery-chain"
...
PROTOCOL = "schema5-v1.2-r12-throughput-qualification-v3"
PLAN_PROTOCOL = "schema5-v1.2-r12-throughput-qualification-load-plan-v3"
INTENT_PROTOCOL = "schema5-v1.2-r12-throughput-qualification-intent-v3"
SCHEDULER_PROTOCOL = (
...
OBSERVATION_TRANSACTION_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-observation-transaction-v3"
)
EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-evidence-v3"
)
LINEAGE_PROTOCOL = "schema5-v1.2-r12-throughput-qualification-lineage-v3"
EXECUTION_AUTHORITY_SCHEMA_VERSION = 2
EXECUTION_AUTHORITY_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-execution-authority-v2"
)
...
FAILURE_DRAIN_INTENT_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-failure-drain-intent-v3"
)
...
PREFLIGHT_CAPACITY_SHORTFALL_PROTOCOL = (
    "schema5-v1.2-r12-throughput-preflight-capacity-shortfall-v1"
)
...
CYCLE_INITIALIZED_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-cycle-initialized-v3"
)
LOAD_EVENT_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-trusted-event-v3"
)
...
LOAD_WINDOW_END_INTENT_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-load-window-end-intent-v3"
)
CYCLE_DRAIN_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-cycle-drain-v3"
)
LOAD_WINDOW_DRAIN_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-load-window-drain-v3"
)
REFILL_RECONCILIATION_PROTOCOL = (
    "schema5-v1.2-r12-throughput-qualification-refill-reconciliation-v3"
)
...
def load_window_ready(
    ...
    """Return whether the immutable window has already met the r12 load gate.
