...
STATUS_PROTOCOL = "schema5-v1.2-r8-bootstrap-status-v1"
...
def _validate_status(
    ...
    comment_prefix = (
        f"asys:s5-recovery-v1.2-r8:{config['chain_id']}:g"
    )
    for row in status_jobs:
        if (
...
def run_once(
    ...
    *,
    ...
    result = {
        "schema_version": 1,
        "protocol": "schema5-v1.2-r8-bootstrap-watchdog-heartbeat-v1",
        "passed": True,
