...
SCHEDULER_EVIDENCE_PROTOCOL = "schema5-v1.2-r12-recovery-scheduler-evidence"
MAIL_PROTOCOL = "schema5-v1.2-r12-recovery-sentinel-mail"
MARKER_PROTOCOL = "schema5-v1.2-r12-recovery-sentinel-outcome"
...
STAGE_SCHEDULER_EVIDENCE_PROTOCOL = (
    "schema5-v1.2-r12-recovery-stage-scheduler-evidence"
)
STAGE_MARKER_PROTOCOL = "schema5-v1.2-r12-recovery-stage-sentinel-outcome"
...
CAPACITY_PREIMAGE_PROTOCOL = "schema5-v1.2-r12-capacity-preimage-archive"
...
def _validate_capacity_transient_receipt(
    ...
    *,
    ...
    if (
        ...
        or evidence.get("chain_protocol") != R12_PROTOCOL
...
def _validate_scheduler_evidence(
    ...
    *,
    ...
    if (
        ...
        or evidence["chain_protocol"] != R12_PROTOCOL
...
def _attempt_mail(
    ...
    *,
    ...
    if isinstance(target_stage, str):
        ...
        body = (
            "Schema-5 v1.2-r12 fail-fast stage observation\n\n"
        ...
        body = (
            "Schema-5 v1.2-r12 recovery-chain outcome\n\n"
            f"Classification: {classification}\n"
            f"Chain: {evidence['chain_id']}\n"
...
def _validate_marker(
    ...
    *,
    ...
    if (
        ...
        or marker["chain_protocol"] != R12_PROTOCOL
...
def _validate_stage_marker(
    ...
    *,
    ...
    if (
        ...
        or marker.get("passed") is not True
        or marker.get("chain_protocol") != R12_PROTOCOL
...
def _verified_inputs(
    ...
    if verified["chain_protocol"] != R12_PROTOCOL:
        raise SentinelError(
            "the afterany recovery sentinel accepts only schema5-v1.2-r12 evidence"
        )
    return verified
...
def run_sentinel(
    *,
    ...
    """Evaluate or durably publish one exact v1.2-r12 recovery-chain outcome."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate the exact schema-5 v1.2-r12 recovery-chain receipt and publish "
